...
function TeamCard() {
  return (
    <Panel shaded bordered bodyFill style={{ display: 'inline-block', width: 335, height: 450, border:'1px solid #ffffff08', borderRadius: '20px', backgroundColor: '#35353580', fontSize:'25px', position:'absolute', left: '25.8vw', top:'24vh' }}>
      ...
      <Panel style={{color: 'white', textAlign:'center', fontSize:'22px'}}>
        <p>
          <small style={{fontWeight:'bold', fontSize:'24px', position:'relative', top:'-25px'}}>
            Las Vegas Llamas
          </small>
        </p>
        <p>
        ...
        <p>
          <small style={{fontSize:'16px', fontWeight:'lighter', color: '#ffffff88',position:'relative', top:'-55px'}}>
            Est. 2020
          </small>
        </p>
        <p>
          <small style={{fontWeight:'normal', position:'relative', top:'-60px', textDecoration: 'underline', fontSize:'23px'}}>
            Record:
          </small>

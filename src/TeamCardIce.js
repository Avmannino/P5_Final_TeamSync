...
function TeamCardIce() {
  return (
    <Panel shaded bordered bodyFill className='ice-panel-card' style={{ display: 'inline-block', width: 335, height: 450, border:'1px solid #ffffff08', borderRadius: '20px', backgroundColor: '#35353550', fontSize:'25px', position:'absolute', left: '21vw', top:'18vh', display: 'flex', flexDirection: 'column', gap: '15vh' }}>
